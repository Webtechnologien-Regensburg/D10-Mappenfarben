...
class RemoteSQLiteDatabase {
    ...
    async insertRecord(record) {
        let query = `INSERT INTO data (age,yearStart,yearEnd,state,green,blue,red,yellow,orange,black,timestamp) VALUES (${record.age},${record.yearStart},${record.yearEnd},"${record.state}","${record.subjectForGreen}","${record.subjectForBlue}","${record.subjectForRed}","${record.subjectForYellow}","${record.subjectForOrange}","${record.subjectForBlack}",${Date.now()})`;
